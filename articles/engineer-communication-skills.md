...
技術的に正しい判断をしても、それが人にうまく伝わらなければプロジェクトはうまく前に進みません。
...
エン：「アクセスが集中してシステムの処理能力を超えちゃってるみたいですね。詳細また連絡します！」
CS：「承知しました！感謝！」
```

専門用語を平易な言葉に置き換えるだけで、相手は安心して顧客対応ができます。**込みいった話の場合は返信文案まで用意**するとさらに良いです。
...
確認事項を投げる時、文章ではなく箇条書きで送ることを心がけています。

オフラインでの会話のように、口語をそのままテキストに用いると無駄なコンテキストが多くなり、本当に必要な情報に辿り着くのが遅れてしまいます。

箇条書きはホワイトボードのような役割を担い、箇条書きにより情報が構造化され、議論の流れが追いやすくなります。

<!-- これは宗教の話になってはしまいますが、冒頭の「お疲れ様です」も不要派です。 -->

また、以下のポイントも意識しています：

- **スレッドの最後に着地結論を書く**：後でスレッドを読んだ人が最終結論に辿り着きやすくなる
- **採用されなかった案は取り消し線**：検討過程も見える化され、後から読んだ人も混乱しません

:::message
**商談中でも、会話をしながらキャッチアップできる粒度**
この状態がストレスなく情報収集できる最適な粒度であると考えています。
:::
...
質問に対して「できます」「できない」とバッサリ真偽値を返すだけではなく、質問の意図を汲み取って寄り添う姿勢を見せることが大切です。
この**小さな寄り添いを積み重ねる**ことで他職能の連携はスムーズになり、信頼も積み重なると考えています。

チームは持ちつ持たれつの関係であり、メンバーの誰かがやらかしてしまった際には **「こいつのためなら仕方ない、いっちょ助けてやるか！」と思えるような関係性**を築くのは、問題の解決速度や心理的安全性の観点からも大切なことだと思います。
